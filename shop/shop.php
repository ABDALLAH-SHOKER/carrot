        ...
        <nav class="navbar navbar-light  navbar-expand-xl"  style=" background-color: #303e48;">
            ...
            <div class="collapse navbar-collapse " id="navbarCollapse"  style=" background-color: #303e48;color: white;">
                <div class="navbar-nav mx-auto"  style=" background-color: #303e48;color: white;">
                    ...
                    <a href="shop.php" style=" color: #adc8b8;" class="nav-item nav-link"><span class="cairo-normal">المتجر</span></a>
                    <a href="cart.php" style=" color: #adc8b8;" class="nav-item nav-link"><span class="cairo-normal">سلة التسوق</span></a>
...
$user_id = $_SESSION['user_id']; // تأكد من تخزين user_id في الجلسة عند تسجيل دخول المستخدم
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo '            <img src="' . $row["image_path"] . '" class="img-fluid w-100 rounded-top" alt=" الصورة مش موجوده">';
                echo '        </div>';
